...
:   QGeoTiledMappingManagerEngine()
{
    ...
    if (parameters.contains(QStringLiteral("osm.api.key"))) {
        apikey = "?apikey=" + parameters.value(QStringLiteral("osm.api.key")).toString();
    } 
    ...
    if(apikey.compare("?apikey=FOO") != 0) {
        providers_cycle.push_back(
            new TileProvider(QStringLiteral("https://tile.thunderforest.com/cycle/%z/%x/%y.png") + apikey,
                QStringLiteral("png"),
    ...
    providers_nighttransit.push_back(
        new TileProvider(QStringLiteral("http://tile.thunderforest.com/transport-dark/%z/%x/%y.png") + apikey,
            QStringLiteral("png"),
            QStringLiteral("<a href='http://www.thunderforest.com/'>Thunderforest</a>"),
            QStringLiteral("<a href='http://www.openstreetmap.org/copyright'>OpenStreetMap</a> contributors")) );
    ...
    providers_terrain.push_back(
        new TileProvider(QStringLiteral("http://tile.thunderforest.com/landscape/%z/%x/%y.png") + apikey,
            QStringLiteral("png"),
            QStringLiteral("<a href='http://www.thunderforest.com/'>Thunderforest</a>"),
            QStringLiteral("<a href='http://www.openstreetmap.org/copyright'>OpenStreetMap</a> contributors")));
    ...
    providers_hiking.push_back(
        new TileProvider(QStringLiteral("http://tile.thunderforest.com/outdoors/%z/%x/%y.png") + apikey,
            QStringLiteral("png"),
            QStringLiteral("<a href='http://www.thunderforest.com/'>Thunderforest</a>"),
            QStringLiteral("<a href='http://www.openstreetmap.org/copyright'>OpenStreetMap</a> contributors")));
    ...
    qWarning() << "Redirection " << disableRedirection;
